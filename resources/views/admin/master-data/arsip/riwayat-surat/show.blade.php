<x-module.admin>
    <x-template.button.back-button url="admin/master-data/arsip/riwayat-surat" />
        <div class="card">
                                        ...
                                        <div class="modal fade" id="modal-lg23d">
                                            <div class="modal-dialog modal-lg">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <embed style="width: 100%; height: 400px" src="{{ url("public/$PengajuanBaru->book_chapter") }}" type="application/pdf">
                                                </div>

...
<head>
    ...
    <!-- favicons -->
    <link rel="apple-touch-icon" sizes="180x180" href="{{url('public/landingpage')}}/assets/images/favicon/logo politap by ifanrifaldi.png">
    <link rel="icon" type="image/png" sizes="32x32" href="{{url('public/landingpage')}}/assets/images/favicon/logo politap by ifanrifaldi.png">
    <link rel="icon" type="image/png" sizes="16x16" href="{{url('public/landingpage')}}/assets/images/favicon/logo politap by ifanrifaldi.png">
    <link rel="manifest" href="{{url('public/landingpage')}}/assets/images/favicon/site.webmanifest">
    ...
    <!-- Plugins CSS -->
    <link rel="stylesheet" href="{{url('public/landingpage')}}/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="{{url('public/landingpage')}}/assets/css/bootstrap-datepicker.min.css">
    <link rel="stylesheet" href="{{url('public/landingpage')}}/assets/css/bootstrap-select.min.css">
    <link rel="stylesheet" href="{{url('public/landingpage')}}/assets/css/fontawesome-all.min.css">
    <link rel="stylesheet" href="{{url('public/landingpage')}}/assets/css/jquery.mCustomScrollbar.min.css">
    <link rel="stylesheet" href="{{url('public/landingpage')}}/assets/css/magnific-popup.css">
    <link rel="stylesheet" href="{{url('public/landingpage')}}/assets/css/owl.carousel.min.css">
    <link rel="stylesheet" href="{{url('public/landingpage')}}/assets/css/owl.theme.default.min.css">
    <link rel="stylesheet" href="{{url('public/landingpage')}}/assets/css/animate.css">
    <link rel="stylesheet" href="{{url('public/landingpage')}}/assets/css/hover-min.css">
    <link rel="stylesheet" href="{{url('public/landingpage')}}/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="{{url('public/landingpage')}}/assets/css/scubo-icons.css">

    <!-- Custom CSS -->
    <link rel="stylesheet" href="{{url('public/landingpage')}}/assets/css/style.css">
    <link rel="stylesheet" href="{{url('public/landingpage')}}/assets/css/responsive.css">
</head>

<body>
    <div class="preloader">
        <img src="{{url('public/landingpage')}}/assets/images/preloader.png" class="preloader__image" alt="">
    </div><!-- /.preloader -->
    <div class="page-wrapper">
        ...
        <nav class="main-nav-one stricky">
            <div class="container">
                ...
                <div class="inner-container">
                    <div class="logo-box">
                        <a href="index.html">
                            <img src="{{url('public/landingpage')}}/assets/images/sipakpol new.png" alt="" width="143">
                        </a>
        ...
        <div class="slider-one__wrapper">
            <div class="slider-one">
                <div class="slider-one__carousel thm__owl-dot-1 owl-carousel owl-theme thm__owl-carousel" data-carousel-prev-btn=".slider-one__nav-right" data-carousel-next-btn=".slider-one__nav-left" data-options='{"loop": true, "items": 1, "margin": 0, "dots": true, "nav": false, "animateOut": &quot;slideOutDown&quot;, "animateIn": &quot;fadeIn&quot;, "active": true, "smartSpeed": 1000, "autoplay": true, "autoplayTimeout": 7000, "autoplayHoverPause": false}'>
                    <div class="item slider-one__slide-1" style="background-image: url({{url('public/landingpage')}}/assets/images/background/backroundlogin.jpg);">
                        <div class="container">
                            <div class="slider-one__content text-center">
                                <p class="anim-elm"> <br> </p>
                                <h3 class="anim-elm"> </h3>
        ...
        <section class="cta-two">
            <div class="cta-two__bg" style="background-image: url({{url('public/landingpage')}}/assets/images/background/footer-bg-1-1.jpg);"></div>
            <!-- /.cta-two__bg -->
            <div class="container">
                <img src="{{url('public/landingpage')}}/assets/images/shapes/slide-ribbon-1-1.png" alt="" class="cta-two__moc">
        ...
        <section class="service-one">
            <img src="{{url('public/landingpage')}}/assets/images/shapes/swimmer-contact-1.png" class="contact-one__swimmer" alt="">


            <!-- footer fishes -->
            <img src="{{url('public/landingpage')}}/assets/images/shapes/fish-service-1.png" alt="" class="site-footer__fish-1">
            <img src="{{url('public/landingpage')}}/assets/images/shapes/fish-service-2.png" alt="" class="site-footer__fish-3">

            <!-- footer trees -->
            <img src="{{url('public/landingpage')}}/assets/images/shapes/tree-service-1.png" class="site-footer__tree-2" alt="">


            <div class="service-one__floated-text">services</div><!-- /.service-one__floated-text -->
            <div class="container">
                <div class="block-title text-center">
                    <img src="{{url('public/landingpage')}}/assets/images/shapes/sec-line-1.png" alt="">
        ...
        <section class="course-one__title">
            <div class="course-one__bg" style="background-image: url({{url('public/landingpage')}}/assets/images/shapes/water-wave-bg.png);"></div>
            <!-- /.course-one__bg -->
            <div class="container ">
        ...
        <div class="course-one course-one__carousel-wrapper">
            <!-- footer fishes -->
            <img src="{{url('public/landingpage')}}/assets/images/shapes/fish-1-1.png" alt="" class="site-footer__fish-1">

            <!-- footer trees -->
            <img src="{{url('public/landingpage')}}/assets/images/shapes/tree-1-1.png" class="site-footer__tree-1" alt="">
            <div class="container">
                        ...
                        <div class="course-one__single">
                            <div class="course-one__image">
                                ...
                                <div class="course-one__image-inner">
                                    <img src="{{url('public/landingpage')}}/assets/images/courses/course-1-1.jpg" alt="">
                    ...
                    <div class="item">
                        <div class="course-one__single">
                            <div class="course-one__image">
                                ...
                                <div class="course-one__image-inner">
                                    <img src="{{url('public/landingpage')}}/assets/images/courses/course-1-2.jpg" alt="">
                                    <a href="course-details.html"><i class="scubo-icon-plus-symbol"></i></a>
                                </div><!-- /.course-one__image-inner -->
                            </div><!-- /.course-one__image -->
                            <div class="course-one__content hvr-sweep-to-bottom">
                    ...
                    <div class="item">
                        <div class="course-one__single">
                            <div class="course-one__image">
                                ...
                                <div class="course-one__image-inner">
                                    <img src="{{url('public/landingpage')}}/assets/images/courses/course-1-3.jpg" alt="">
                                    <a href="course-details.html"><i class="scubo-icon-plus-symbol"></i></a>
                                </div><!-- /.course-one__image-inner -->
                            </div><!-- /.course-one__image -->
                            <div class="course-one__content hvr-sweep-to-bottom">
                    ...
                    <div class="item">
                        <div class="course-one__single">
                            <div class="course-one__image">
                                <a href="course-details.html" class="course-one__cat">advanced</a>
                                <div class="course-one__image-inner">
                                    <img src="{{url('public/landingpage')}}/assets/images/courses/course-1-4.jpg" alt="">
                                    <a href="course-details.html"><i class="scubo-icon-plus-symbol"></i></a>
                                </div><!-- /.course-one__image-inner -->
                            </div><!-- /.course-one__image -->
                            <div class="course-one__content hvr-sweep-to-bottom">
                    ...
                    <div class="item">
                        <div class="course-one__single">
                            <div class="course-one__image">
                                <a href="course-details.html" class="course-one__cat">advanced</a>
                                <div class="course-one__image-inner">
                                    <img src="{{url('public/landingpage')}}/assets/images/courses/course-1-5.jpg" alt="">
                                    <a href="course-details.html"><i class="scubo-icon-plus-symbol"></i></a>
                                </div><!-- /.course-one__image-inner -->
                            </div><!-- /.course-one__image -->
                            <div class="course-one__content hvr-sweep-to-bottom">
                    ...
                    <div class="item">
                        <div class="course-one__single">
                            <div class="course-one__image">
                                <a href="course-details.html" class="course-one__cat">Professional</a>
                                <div class="course-one__image-inner">
                                    <img src="{{url('public/landingpage')}}/assets/images/courses/course-1-6.jpg" alt="">
                                    <a href="course-details.html"><i class="scubo-icon-plus-symbol"></i></a>
                                </div><!-- /.course-one__image-inner -->
                            </div><!-- /.course-one__image -->
                            <div class="course-one__content hvr-sweep-to-bottom">
        ...
        <section class="video-two" style="background-image: url({{url('public/landingpage')}}/assets/images/shapes/video-2-bg.png);">
            <img src="{{url('public/landingpage')}}/assets/images/shapes/swimmer-1-1.png" class="video-two__swimmer" alt="">
            <div class="container">
                <div class="video-two__box wow fadeInRight" data-wow-duration="1500ms">
                    <img src="{{url('public/landingpage')}}/assets/images/resources/video-1-1.jpg" alt="">
        ...
        <section class="testimonials-one__title testimonials-one__title__home-one">
            <div class="testimonials-one__bg" style="background-image: url({{url('public/landingpage')}}/assets/images/shapes/water-wave-bg.png);"></div>
                                    ...
                                    <div class="testimonials-one__infos">
                                        <div class="testimonials-one__image">
                                            <div class="testimonials-one__image-inner">
                                                <img src="{{url('public/landingpage')}}/assets/images/resources/testi-1-1.jpg" alt="">
                            ...
                            <div class="testimonials-one__content">
                                <div class="testimonials-one__content-inner">
                                    ...
                                    <div class="testimonials-one__infos">
                                        <div class="testimonials-one__image">
                                            <div class="testimonials-one__image-inner">
                                                <img src="{{url('public/landingpage')}}/assets/images/resources/testi-1-2.jpg" alt="">
                                            </div><!-- /.testimonials-one__image-inner -->
                                        </div><!-- /.testimonials-one__image -->
                                        <div class="testimonials-one__infos-content">
                                            <h3>Joel Moore</h3>
                            ...
                            <div class="testimonials-one__content">
                                <div class="testimonials-one__content-inner">
                                    ...
                                    <div class="testimonials-one__infos">
                                        <div class="testimonials-one__image">
                                            <div class="testimonials-one__image-inner">
                                                <img src="{{url('public/landingpage')}}/assets/images/resources/testi-1-3.jpg" alt="">
                                            </div><!-- /.testimonials-one__image-inner -->
                                        </div><!-- /.testimonials-one__image -->
                                        <div class="testimonials-one__infos-content">
                                            <h3>Pauline Cross</h3>
                            ...
                            <div class="testimonials-one__content">
                                <div class="testimonials-one__content-inner">
                                    ...
                                    <div class="testimonials-one__infos">
                                        <div class="testimonials-one__image">
                                            <div class="testimonials-one__image-inner">
                                                <img src="{{url('public/landingpage')}}/assets/images/resources/testi-1-4.jpg" alt="">
                                            </div><!-- /.testimonials-one__image-inner -->
                                        </div><!-- /.testimonials-one__image -->
                                        <div class="testimonials-one__infos-content">
        ...
        <section class="cta-three">
            <img src="{{url('public/landingpage')}}/assets/images/resources/cta-1-1.png" class="cta-three__moc wow fadeInRight" data-wow-duration="1500ms" alt="">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="cta-four__image wow fadeInLeft" data-wow-duration="1500ms">
                            <img src="{{url('public/landingpage')}}/assets/images/resources/cta-2-1.jpg" alt="">
        ...
        <section class="cta-five">
            <div class="cta-five__bg" style="background-image: url({{url('public/landingpage')}}/assets/images/background/cta-5-1-bg.jpg);"></div><!-- /.cta-five__bg -->
            <div class="container">
        ...
        <section class="blog-one blog-one__home-one" style="background-image: url({{url('public/landingpage')}}/assets/images/shapes/about-brand-team-bg.png);">
            <div class="container">
                <div class="block-title text-center">
                    <img src="{{url('public/landingpage')}}/assets/images/shapes/sec-line-1.png" alt="">
                        ...
                        <div class="blog-one__single">
                            <div class="blog-one__image">
                                ...
                                <div class="blog-one__image-inner">
                                    <img src="{{url('public/landingpage')}}/assets/images/blog/blog-1-1.jpg" alt="">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="blog-one__single">
                            <div class="blog-one__image">
                                <a href="news-details.html" class="blog-one__date">02 Jan, 2020</a>
                                <div class="blog-one__image-inner">
                                    <img src="{{url('public/landingpage')}}/assets/images/blog/blog-1-2.jpg" alt="">
                                    <a href="news-details.html"><i class="scubo-icon-plus-symbol"></i></a>
                                </div><!-- /.blog-one__image-inner -->
                            </div><!-- /.blog-one__image -->
                            <div class="blog-one__content">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="blog-one__single">
                            <div class="blog-one__image">
                                <a href="news-details.html" class="blog-one__date">02 Jan, 2020</a>
                                <div class="blog-one__image-inner">
                                    <img src="{{url('public/landingpage')}}/assets/images/blog/blog-1-3.jpg" alt="">
                                    <a href="news-details.html"><i class="scubo-icon-plus-symbol"></i></a>
                                </div><!-- /.blog-one__image-inner -->
                            </div><!-- /.blog-one__image -->
                            <div class="blog-one__content">
        ...
        <section class="brand-one brand-one__home-one">
            <div class="container">
                <div class="brand-one__carousel owl-carousel thm__owl-carousel owl-theme" data-options='{"loop": true, "autoplay": true, "autoplayHoverPause": true, "autoplayTimeout": 5000, "items": 5, "dots": false, "nav": false, "margin": 100, "smartSpeed": 700, "responsive": { "0": {"items": 2, "margin": 30}, "480": {"items": 3, "margin": 30}, "991": {"items": 4, "margin": 50}, "1199": {"items": 5, "margin": 100}}}'>
                    <div class="item">
                        <img src="{{url('public/landingpage')}}/assets/images/brand/brand-1-1.png" alt="">
                    </div><!-- /.item -->
                    <div class="item">
                        <img src="{{url('public/landingpage')}}/assets/images/brand/brand-1-2.png" alt="">
                    </div><!-- /.item -->
                    <div class="item">
                        <img src="{{url('public/landingpage')}}/assets/images/brand/brand-1-3.png" alt="">
                    </div><!-- /.item -->
                    <div class="item">
                        <img src="{{url('public/landingpage')}}/assets/images/brand/brand-1-4.png" alt="">
                    </div><!-- /.item -->
                    <div class="item">
                        <img src="{{url('public/landingpage')}}/assets/images/brand/brand-1-5.png" alt="">
                    </div><!-- /.item -->
                    <div class="item">
                        <img src="{{url('public/landingpage')}}/assets/images/brand/brand-1-6.png" alt="">
                    </div><!-- /.item -->
                    <div class="item">
                        <img src="{{url('public/landingpage')}}/assets/images/brand/brand-1-1.png" alt="">
                    </div><!-- /.item -->
        ...
        <footer class="site-footer-one">
            ...
            <div class="site-footer-one__bg" style="background-image: url({{url('public/landingpage')}}/assets/images/background/footer-bg-1-1.jpg);"></div>
            <!-- /.site-footer-one__bg -->

            <!-- footer fishes -->
            <img src="{{url('public/landingpage')}}/assets/images/shapes/fish-f-1.png" alt="" class="site-footer__fish-1">
            <img src="{{url('public/landingpage')}}/assets/images/shapes/fish-f-2.png" alt="" class="site-footer__fish-2">
            <img src="{{url('public/landingpage')}}/assets/images/shapes/fish-f-3.png" alt="" class="site-footer__fish-3">

            <!-- footer trees -->
            <img src="{{url('public/landingpage')}}/assets/images/shapes/tree-f-1.png" class="site-footer__tree-1" alt="">
            <img src="{{url('public/landingpage')}}/assets/images/shapes/tree-f-2.png" class="site-footer__tree-2" alt="">
                    ...
                    <div class="footer-widget-row">
                        <div class="footer-widget footer-widget__about">
                            <div class="footer-widget__inner">
                                <a href="index.html">
                                    <img src="{{url('public/landingpage')}}/assets/images/logo-2-1.png" alt="" width="143">
                                </a>
    ...
    <div class="side-menu__block">
        ...
        <div class="side-menu__block-inner ">
            ...
            <a href="index.html" class="side-menu__logo"><img src="{{url('public/landingpage')}}/assets/images/logo-3-1.png" alt="" width="143"></a>
    ...
    <!-- Template JS -->
    <script src="{{url('public/landingpage')}}/assets/js/jquery.min.js"></script>
    <script src="{{url('public/landingpage')}}/assets/js/bootstrap.bundle.min.js"></script>
    <script src="{{url('public/landingpage')}}/assets/js/bootstrap-datepicker.min.js"></script>
    <script src="{{url('public/landingpage')}}/assets/js/bootstrap-select.min.js"></script>
    <script src="{{url('public/landingpage')}}/assets/js/isotope.js"></script>
    <script src="{{url('public/landingpage')}}/assets/js/jquery.ajaxchimp.min.js"></script>
    <script src="{{url('public/landingpage')}}/assets/js/jquery.counterup.min.js"></script>
    <script src="{{url('public/landingpage')}}/assets/js/jquery.magnific-popup.min.js"></script>
    <script src="{{url('public/landingpage')}}/assets/js/jquery.mCustomScrollbar.concat.min.js"></script>
    <script src="{{url('public/landingpage')}}/assets/js/jquery.validate.min.js"></script>
    <script src="{{url('public/landingpage')}}/assets/js/owl.carousel.min.js"></script>
    <script src="{{url('public/landingpage')}}/assets/js/TweenMax.min.js"></script>
    <script src="{{url('public/landingpage')}}/assets/js/waypoints.min.js"></script>
    <script src="{{url('public/landingpage')}}/assets/js/wow.min.js"></script>

    <!-- Custom Scripts -->
    <script src="{{url('public/landingpage')}}/assets/js/theme.js"></script>
</body>

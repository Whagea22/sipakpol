...
<head>
    ...
    <!-- favicons -->
    <link rel="apple-touch-icon" sizes="180x180" href="{{url('public/landingpage')}}/assets/images/favicon/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="{{url('public/landingpage')}}/assets/images/favicon/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="{{url('public/landingpage')}}/assets/images/favicon/favicon-16x16.png">
        ...
        <nav class="main-nav-one stricky">
            <div class="container">
                ...
                <div class="inner-container">
                    <div class="logo-box">
                        <a href="index.html">
                            <img src="{{url('public/landingpage')}}/assets/images/logo-1-1.png" alt="" width="143">
                        </a>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="blog-details__main">
                            <div class="blog-one__image">
                                ...
                                <div class="blog-one__image-inner">
                                    <img src="{{url('public/landingpage')}}/assets/images/blog/blog-d-1-1.jpg" alt="">
                        ...
                        <div class="blog-details__author">
                            <img src="{{url('public/landingpage')}}/assets/images/blog/author-1-1.jpg" alt="">
                            <h3>Sarah Rose</h3>
                        ...
                        <div class="comment-one">
                            ...
                            <div class="comment-one__single">
                                <img src="{{url('public/landingpage')}}/assets/images/blog/comment-1-1.jpg" alt="">
                            ...
                            <div class="comment-one__single">
                                <img src="{{url('public/landingpage')}}/assets/images/blog/comment-1-2.jpg" alt="">
                                <div class="comment-one__top">
                        ...
                        <div class="comment-form__wrapper">
                            ...
                            <form action="{{url('public/landingpage')}}/assets/inc/sendemail.php" class="contact-one__form comment-one__form contact-form-validated">
                                <div class="row">
                                    <div class="col-md-6">
                        ...
                        <div class="sidebar">
                            ...
                            <div class="sidebar__single sidebar__post">
                                ...
                                <ul class="sidebar__post-list list-unstyled">
                                    <li>
                                        <img src="{{url('public/landingpage')}}/assets/images/blog/lp-1-1.jpg" alt="">
                                    ...
                                    <li>
                                        <img src="{{url('public/landingpage')}}/assets/images/blog/lp-1-2.jpg" alt="">
                                        <div class="sidebar__post__meta">
                                            <a href="news-details.html"><i class="far fa-user-circle"></i> Admin</a>
                                        </div><!-- /.sidebar__post__meta -->
                                        <h3><a href="news-details.html">Learn how to do Scuba diving in Island</a></h3>
                                    ...
                                    <li>
                                        <img src="{{url('public/landingpage')}}/assets/images/blog/lp-1-3.jpg" alt="">
                                        <div class="sidebar__post__meta">
                                            <a href="news-details.html"><i class="far fa-user-circle"></i> Admin</a>
                                        </div><!-- /.sidebar__post__meta -->
                                        <h3><a href="news-details.html">Learn how to do Scuba diving in Island</a></h3>

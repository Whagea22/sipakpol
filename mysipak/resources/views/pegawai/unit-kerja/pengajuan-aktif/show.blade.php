<x-module.pegawai-unitkerja>
    <x-template.button.back-button url="pegawai/unit-kerja/pengajuan-aktif" />
    <div class="card">
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-md-6">
              <dl>
                <dt>Nama Penerbit, Nama Buku / Karya</dt>
            ...
            {{-- <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <embed style="width: 100%; height: 450px" src="{{ url("public/$pengajuanbaru->file_surat") }}" type="application/pdf">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="" class="control-label">File Lampiran</label>
                        <embed style="width: 100%; height: 450px" src="{{ url("public/$pengajuanbaru->file_lampiran") }}" type="application/pdf">
                    </div>
                </div>
            </div>   --}}
        </div>
